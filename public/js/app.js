...
Vue.component('create-survey', __webpack_require__(38));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'survey-question': __webpack_require__(39)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getSurvey: function getSurvey() {
      ...
      axios.get('/api/survey/' + survey_id).then(function (res) {
        var data = res.data;
...
Component.options.__file = "/Users/jaydeluca/code/JD/DigDatSurvey/resources/assets/js/components/CreateSurveyQuestion.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CreateSurveyQuestion.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-25d6d95f", Component.options)
  } else {
    hotAPI.reload("data-v-25d6d95f", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-25d6d95f", module.exports)
  }
}
